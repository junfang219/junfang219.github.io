...
evidencesB.addEventListener("click", function() {
	evidenceDropdown.innerHTML = "Silver Phalanx/ Centurion";
...
evidences1B.addEventListener("click", function() {
	evidenceDropdown.innerHTML = "Rattle-Jacks/ Jack-knife";
...
evidences2B.addEventListener("click", function() {
	evidenceDropdown.innerHTML = "General Note Regarding Sources";
...
evidences3B.addEventListener("click", function() {
	evidenceDropdown.innerHTML = "Part 1: First Round";
...
evidences4B.addEventListener("click", function() {
	evidenceDropdown.innerHTML = "Part 2: Second Round";
