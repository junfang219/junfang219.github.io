const scripts = [
  {text:'Please click the Case 1 dropdown menu and read Case 1, Case 1 Senarios, and Case 1 Questions in turn. Your task is to answer the questions on Case 1 Questions Tab. The Bayesian tree on the right colunm will help you to solve the case. You can click the probability and percentage buttons above the tree to change the representations. Click Next after you finish reading the information. '},
